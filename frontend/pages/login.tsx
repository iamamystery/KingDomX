...
export default function Login() {
  ...
  async function submit(e: any) {
    e.preventDefault()
    // Mock login for static export - accept any credentials
    localStorage.setItem('token', 'mock-token-for-demo')
    localStorage.setItem('user', JSON.stringify({ name: 'Muhammad Jawad', email, role: 'ADMIN' }))
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mt-4">
            <div className="relative mb-3">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-[#0a0a0f] text-white/40">Demo accounts</span>
              </div>
            </div>
